...
numero = 3
resultado = (
    "El número es par" if numero % 2 == 0 
...
# Tienes una cesta de frutas y quieres saber si tienes manzanas, 
# si hay manzanas las cuentas y si no hay compras dos manzanas
